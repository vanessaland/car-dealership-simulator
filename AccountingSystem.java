...
public class AccountingSystem
{
    ...
    {
    	//map for all the transactions with their ID
        transactionMap = new TreeMap<Integer, Transaction>();
        
        //map for the amount of sales in each month
        ...
        //map for the amount of sales per salesperson
    ...
    {
    	//loop through and display the map of transactionIDs and transaction objects
    ...
    {
    	//loop through the map of salesperson sales to find salesperson(s) with the highest amount
    ...
    public void stats()
    {
    	//loop through the map of monthly sales to find the top month and amount
    ...
    {
    	//loop through transaction map to find the transactions during the month input by user
    	Set<Integer> keySet = transactionMap.keySet();	
        System.out.println("-------------------------------");
